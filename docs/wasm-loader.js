...
(() => {
    ...
    async function load() {
        ...
        loading = (async () => {
            const mod = await import("./wasm/acoustic_engine.js?v=0.17.0");
            if (typeof mod.default === "function") await mod.default({ module_or_path: "./wasm/acoustic_engine_bg.wasm?v=0.17.0" });
            moduleRef = mod;
            return mod;
        })().catch(error => {
